...
describe('XmppComponentSession outbound IQ requests', () => {
  ...
  it('handles a disconnect while opening without an unhandled rejection', async () => {
    const first = createMockClient();
    ...
    vi.mocked(component).mockReturnValue(first as unknown as ReturnType<typeof component>);
