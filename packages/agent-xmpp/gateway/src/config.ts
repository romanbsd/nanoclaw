import {
  createProtocolNamespaces,
  DEFAULT_PROTOCOL_PROFILE,
  type AgentXmppNamespaces,
  type AgentXmppProtocolProfile,
...
export interface GatewayConfig {
  ...
  /** Explicit protocol identity; omitted by legacy programmatic callers. */
  protocolProfile?: AgentXmppProtocolProfile;
...
export function loadConfig(): GatewayConfig {
  ...
  return {
    ...
    protocolProfile,
    protocolNamespaces: createProtocolNamespaces(protocolProfile),
  };
}
