...
[a2aproject/A2A](https://github.com/a2aproject/A2A "Go to repository")

* [Home](..)
* [Documentation](../topics/what-is-a2a/)
...
[![logo](../assets/a2a_logo/icon/white/SVG/a2a_icon_white.svg)](.. "A2A Protocol")
A2A Protocol
...
* [ ]
  ...
  + [A2A and MCP](../topics/a2a-and-mcp/)
  + [Core Concepts](../topics/key-concepts/)
  + [Life of a Task](../topics/life-of-a-task/)
  + [Agent Discovery](../topics/agent-discovery/)
  + [Enterprise Features](../topics/enterprise-ready/)
  + [Streaming & Asynchronous Operations](../topics/streaming-and-async/)
  + [Multi-Tenancy](../topics/multi-tenancy/)
* [ ]

  Extensions

  Extensions
  + [Overview](../topics/extensions/)
  + [Custom Protocol Bindings](../topics/custom-protocol-bindings/)
  + [Extension & Binding Governance](../topics/extension-and-binding-governance/)
* [x]
  ...
  + [ ]
    ...
    - [3. A2A Protocol Operations](#3-a2a-protocol-operations)
      ...
      * [3.1. Core Operations](#31-core-operations)
        ...
        + [3.1.1. Send Message](#311-send-message)
        + [3.1.2. Send Streaming Message](#312-send-streaming-message)
        + [3.1.3. Get Task](#313-get-task)
        + [3.1.4. List Tasks](#314-list-tasks)
        + [3.1.5. Cancel Task](#315-cancel-task)
        + [3.1.6. Subscribe to Task](#316-subscribe-to-task)
        + [3.1.7. Create Push Notification Config](#317-create-push-notification-config)
        + [3.1.8. Get Push Notification Config](#318-get-push-notification-config)
        + [3.1.9. List Push Notification Configs](#319-list-push-notification-configs)
        + [3.1.10. Delete Push Notification Config](#3110-delete-push-notification-config)
        + [3.1.11. Get Extended Agent Card](#3111-get-extended-agent-card)
      * [3.2. Operation Parameter Objects](#32-operation-parameter-objects)

        + [3.2.1. SendMessageRequest](#321-sendmessagerequest)
        + [3.2.2. SendMessageConfiguration](#322-sendmessageconfiguration)
        + [3.2.3. Stream Response](#323-stream-response)
        + [3.2.4. History Length Semantics](#324-history-length-semantics)
        + [3.2.5. Metadata](#325-metadata)
        + [3.2.6 Service Parameters](#326-service-parameters)
      * [3.3. Operation Semantics](#33-operation-semantics)

        + [3.3.1. Idempotency](#331-idempotency)
        + [3.3.2. Error Handling](#332-error-handling)
        + [3.3.3. Asynchronous Processing](#333-asynchronous-processing)
        + [3.3.4. Capability Validation](#334-capability-validation)
      * [3.4. Multi-Turn Interactions](#34-multi-turn-interactions)

        + [3.4.1. Context Identifier Semantics](#341-context-identifier-semantics)
        + [3.4.2. Task Identifier Semantics](#342-task-identifier-semantics)
        + [3.4.3. Multi-Turn Conversation Patterns](#343-multi-turn-conversation-patterns)
      * [3.5. Task Update Delivery Mechanisms](#35-task-update-delivery-mechanisms)

        + [3.5.1. Overview of Update Mechanisms](#351-overview-of-update-mechanisms)
        + [3.5.2. Streaming Event Delivery](#352-streaming-event-delivery)
        + [3.5.3. Push Notification Delivery](#353-push-notification-delivery)
      * [3.6 Versioning](#36-versioning)

        + [3.6.1 Client Responsibilities](#361-client-responsibilities)
        + [3.6.2 Server Responsibilities](#362-server-responsibilities)
        + [3.6.3 Tooling support](#363-tooling-support)
    ...
    - [4. Protocol Data Model](#4-protocol-data-model)
      ...
      * [4.1. Core Objects](#41-core-objects)
        ...
        + [4.1.1. Task](#411-task)
        + [4.1.2. TaskStatus](#412-taskstatus)
        + [4.1.3. TaskState](#413-taskstate)
        + [4.1.4. Message](#414-message)
        + [4.1.5. Role](#415-role)
        + [4.1.6. Part](#416-part)
        + [4.1.7. Artifact](#417-artifact)
      * [4.2. Streaming Events](#42-streaming-events)

        + [4.2.1. TaskStatusUpdateEvent](#421-taskstatusupdateevent)
        + [4.2.2. TaskArtifactUpdateEvent](#422-taskartifactupdateevent)
      * [4.3. Push Notification Objects](#43-push-notification-objects)

        + [4.3.1. PushNotificationConfig](#431-pushnotificationconfig)
        + [4.3.2. AuthenticationInfo](#432-authenticationinfo)
        + [4.3.3. Push Notification Payload](#433-push-notification-payload)
      * [4.4. Agent Discovery Objects](#44-agent-discovery-objects)

        + [4.4.1. AgentCard](#441-agentcard)
        + [4.4.2. AgentProvider](#442-agentprovider)
        + [4.4.3. AgentCapabilities](#443-agentcapabilities)
        + [4.4.4. AgentExtension](#444-agentextension)
        + [4.4.5. AgentSkill](#445-agentskill)
        + [4.4.6. AgentInterface](#446-agentinterface)
        + [4.4.7. AgentCardSignature](#447-agentcardsignature)
      * [4.5. Security Objects](#45-security-objects)

        + [4.5.1. SecurityScheme](#451-securityscheme)
        + [4.5.2. APIKeySecurityScheme](#452-apikeysecurityscheme)
        + [4.5.3. HTTPAuthSecurityScheme](#453-httpauthsecurityscheme)
        + [4.5.4. OAuth2SecurityScheme](#454-oauth2securityscheme)
        + [4.5.5. OpenIdConnectSecurityScheme](#455-openidconnectsecurityscheme)
        + [4.5.6. MutualTlsSecurityScheme](#456-mutualtlssecurityscheme)
        + [4.5.7. OAuthFlows](#457-oauthflows)
        + [4.5.8. AuthorizationCodeOAuthFlow](#458-authorizationcodeoauthflow)
        + [4.5.9. ClientCredentialsOAuthFlow](#459-clientcredentialsoauthflow)
        + [4.5.10. DeviceCodeOAuthFlow](#4510-devicecodeoauthflow)
      * [4.6. Extensions](#46-extensions)

        + [4.6.1. Extension Declaration](#461-extension-declaration)
        + [4.6.2. Extensions Points](#462-extensions-points)
        + [4.6.3. Extension Versioning and Compatibility](#463-extension-versioning-and-compatibility)
    - [5. Protocol Binding Requirements and Interoperability](#5-protocol-binding-requirements-and-interoperability)
      ...
      * [5.6. Data Type Conventions](#56-data-type-conventions)
        ...
        + [5.6.1. Timestamps](#561-timestamps)
    ...
    - [6. Common Workflows & Examples](#6-common-workflows-examples)
      ...
      * [6.5. Task Listing and Management](#65-task-listing-and-management)
        ...
        + [Request: All tasks from a specific context](#request-all-tasks-from-a-specific-context)
        + [Request: All working tasks across all contexts](#request-all-working-tasks-across-all-contexts)
    ...
    - [7. Authentication and Authorization](#7-authentication-and-authorization)
      ...
      * [7.6. In-Task Authorization](#76-in-task-authorization)
        ...
        + [7.6.1 In-Task Authorization Agent Responsibilities](#761-in-task-authorization-agent-responsibilities)
        + [7.6.2 In-Task Authorization Client Responsibilities](#762-in-task-authorization-client-responsibilities)
        + [7.6.3 In-Task Authorization Security Considerations](#763-in-task-authorization-security-considerations)
    - [8. Agent Discovery: The Agent Card](#8-agent-discovery-the-agent-card)
      ...
      * [8.3. Protocol Declaration Requirements](#83-protocol-declaration-requirements)
        ...
        + [8.3.1. Supported Interfaces Declaration](#831-supported-interfaces-declaration)
        + [8.3.2. Client Protocol Selection](#832-client-protocol-selection)
      * [8.4. Agent Card Signing](#84-agent-card-signing)

        + [8.4.1. Canonicalization Requirements](#841-canonicalization-requirements)
        + [8.4.2. Signature Format](#842-signature-format)
        + [8.4.3. Signature Verification](#843-signature-verification)
      * [8.5. Sample Agent Card](#85-sample-agent-card)
      * [8.6. Caching](#86-caching)

        + [8.6.1. Server Requirements](#861-server-requirements)
        + [8.6.2. Client Requirements](#862-client-requirements)
    - [9. JSON-RPC Protocol Binding](#9-json-rpc-protocol-binding)
      ...
      * [9.4. Core Methods](#94-core-methods)
        ...
        + [9.4.1. SendMessage](#941-sendmessage)
        + [9.4.2. SendStreamingMessage](#942-sendstreamingmessage)
        + [9.4.3. GetTask](#943-gettask)
        + [9.4.4. ListTasks](#944-listtasks)
        + [9.4.5. CancelTask](#945-canceltask)
        + [9.4.6. SubscribeToTask](#946-subscribetotask)
        + [9.4.7. Push Notification Configuration Methods](#947-push-notification-configuration-methods)
        + [9.4.8. GetExtendedAgentCard](#948-getextendedagentcard)
    ...
    - [10. gRPC Protocol Binding](#10-grpc-protocol-binding)
      ...
      * [10.4. Core Methods](#104-core-methods)
        ...
        + [10.4.1. SendMessage](#1041-sendmessage)
        + [10.4.2. SendStreamingMessage](#1042-sendstreamingmessage)
        + [10.4.3. GetTask](#1043-gettask)
        + [10.4.4. ListTasks](#1044-listtasks)
        + [10.4.5. CancelTask](#1045-canceltask)
        + [10.4.6. SubscribeToTask](#1046-subscribetotask)
        + [10.4.7. CreateTaskPushNotificationConfig](#1047-createtaskpushnotificationconfig)
        + [10.4.8. GetTaskPushNotificationConfig](#1048-gettaskpushnotificationconfig)
        + [10.4.9. ListTaskPushNotificationConfigs](#1049-listtaskpushnotificationconfigs)
        + [10.4.10. DeleteTaskPushNotificationConfig](#10410-deletetaskpushnotificationconfig)
        + [10.4.11. GetExtendedAgentCard](#10411-getextendedagentcard)
      * [10.5. gRPC-Specific Data Types](#105-grpc-specific-data-types)

        + [10.5.1. TaskPushNotificationConfig](#1051-taskpushnotificationconfig)
    ...
    - [11. HTTP+JSON/REST Protocol Binding](#11-httpjsonrest-protocol-binding)
      ...
      * [11.3. URL Patterns and HTTP Methods](#113-url-patterns-and-http-methods)
        ...
        + [11.3.1. Message Operations](#1131-message-operations)
        + [11.3.2. Task Operations](#1132-task-operations)
        + [11.3.3. Push Notification Configuration](#1133-push-notification-configuration)
        + [11.3.4. Agent Card](#1134-agent-card)
    ...
    - [14. IANA Considerations](#14-iana-considerations)
      ...
      * [14.1. Media Type Registration](#141-media-type-registration)
        ...
        + [14.1.1. application/a2a+json](#1411-applicationa2ajson)
      * [14.2. HTTP Header Field Registrations](#142-http-header-field-registrations)

        + [14.2.1. A2A-Version Header](#1421-a2a-version-header)
        + [14.2.2. A2A-Extensions Header](#1422-a2a-extensions-header)
    ...
    - [Appendix A. Migration & Legacy Compatibility](#appendix-a-migration-legacy-compatibility)
      ...
      * [A.2 Migration Guidance](#a2-migration-guidance)
        ...
        + [A.2.1 Breaking Change: Kind Discriminator Removed](#a21-breaking-change-kind-discriminator-removed)
        + [A.2.2 Breaking Change: Extended Agent Card Field Relocated](#a22-breaking-change-extended-agent-card-field-relocated)
  ...
  + [What's New in v1.0](../whats-new-v1/)
  + [Protocol Definition](../definitions/)
* [ ]
  ...
  + [ ]
    ...
    - [ ]
      ...
      Quickstart (Python)
      * [Introduction](../tutorials/python/1-introduction/)
      * [Setup](../tutorials/python/2-setup/)
      * [Agent Skills & Agent Card](../tutorials/python/3-agent-skills-and-card/)
      * [Agent Executor](../tutorials/python/4-agent-executor/)
      * [Start Server](../tutorials/python/5-start-server/)
      * [Interact with Server](../tutorials/python/6-interact-with-server/)
      * [Streaming & Multiturn](../tutorials/python/7-streaming-and-multiturn/)
      * [Next Steps](../tutorials/python/8-next-steps/)
...
* [ ]
  ...
  Blog
  + [🆕 Announcing Version 1.0](../announcing-1.0/)
...
# Agent2Agent (A2A) Protocol Specification[¶](#agent2agent-a2a-protocol-specification "Permanent link")
...
### 1.1. Key Goals of A2A[¶](#11-key-goals-of-a2a "Permanent link")
...
### 1.2. Guiding Principles[¶](#12-guiding-principles "Permanent link")
...
For a broader understanding of A2A's purpose and benefits, see [What is A2A?](../topics/what-is-a2a/).

### 1.3. Specification Structure[¶](#13-specification-structure "Permanent link")
...
### 1.4 Normative Content[¶](#14-normative-content "Permanent link")
...
## 2. Terminology[¶](#2-terminology "Permanent link")

### 2.1. Requirements Language[¶](#21-requirements-language "Permanent link")

The keywords "MUST", "MUST NOT", "REQUIRED", "SHALL", "SHALL NOT", "SHOULD", "SHOULD NOT", "RECOMMENDED", "MAY", and "OPTIONAL" in this document are to be interpreted as described in [RFC 2119](https://tools.ietf.org/html/rfc2119).

### 2.2. Core Concepts[¶](#22-core-concepts "Permanent link")

A2A revolves around several key concepts. For detailed explanations, please refer to the [Key Concepts guide](../topics/key-concepts/).
...
## 3. A2A Protocol Operations[¶](#3-a2a-protocol-operations "Permanent link")
...
### 3.1. Core Operations[¶](#31-core-operations "Permanent link")
...
#### 3.1.1. Send Message[¶](#311-send-message "Permanent link")
...
#### 3.1.2. Send Streaming Message[¶](#312-send-streaming-message "Permanent link")
...
#### 3.1.3. Get Task[¶](#313-get-task "Permanent link")
...
#### 3.1.4. List Tasks[¶](#314-list-tasks "Permanent link")
...
| `status` | [`TaskState`](#taskstate) | No | Filter tasks by their current status state. |
...
| Field | Type | Required | Description |
| --- | --- | --- | --- |
| `tasks` | array of [`Task`](#task) | Yes | Array of tasks matching the specified criteria. |
...
#### 3.1.5. Cancel Task[¶](#315-cancel-task "Permanent link")
...
#### 3.1.6. Subscribe to Task[¶](#316-subscribe-to-task "Permanent link")
...
#### 3.1.7. Create Push Notification Config[¶](#317-create-push-notification-config "Permanent link")
...
| `authentication` | [`AuthenticationInfo`](#authenticationinfo) | No | Authentication information required to send the notification. |
...
#### 3.1.8. Get Push Notification Config[¶](#318-get-push-notification-config "Permanent link")
...
#### 3.1.9. List Push Notification Configs[¶](#319-list-push-notification-configs "Permanent link")
...
| Field | Type | Required | Description |
| --- | --- | --- | --- |
| `configs` | array of [`TaskPushNotificationConfig`](#taskpushnotificationconfig) | No | The list of push notification configurations. |
...
#### 3.1.10. Delete Push Notification Config[¶](#3110-delete-push-notification-config "Permanent link")
...
#### 3.1.11. Get Extended Agent Card[¶](#3111-get-extended-agent-card "Permanent link")
...
### 3.2. Operation Parameter Objects[¶](#32-operation-parameter-objects "Permanent link")

This section defines common parameter objects used across multiple operations.

#### 3.2.1. SendMessageRequest[¶](#321-sendmessagerequest "Permanent link")
...
| --- | --- | --- | --- |
| `tenant` | `string` | No | Optional. Opaque routing identifier. Must match the `tenant` value from the selected `AgentInterface` in the Agent Card when that field is set. |
| `message` | [`Message`](#message) | Yes | The message to send to the agent. |
| `configuration` | [`SendMessageConfiguration`](#sendmessageconfiguration) | No | Configuration for the send request. |
| `metadata` | `object` | No | A flexible key-value map for passing additional context or parameters. |

#### 3.2.2. SendMessageConfiguration[¶](#322-sendmessageconfiguration "Permanent link")
...
| `taskPushNotificationConfig` | [`TaskPushNotificationConfig`](#taskpushnotificationconfig) | No | Configuration for the agent to send push notifications for task updates. Task id should be empty when sending this configuration in a `SendMessage` request. |
...
#### 3.2.3. Stream Response[¶](#323-stream-response "Permanent link")

A wrapper object used in streaming operations to encapsulate different types of response data.

| Field | Type | Required | Description |
| --- | --- | --- | --- |
| `task` | [`Task`](#task) | Optional (OneOf) | A Task object containing the current state of the task. |
| `message` | [`Message`](#message) | Optional (OneOf) | A Message object containing a message from the agent. |
| `statusUpdate` | [`TaskStatusUpdateEvent`](#taskstatusupdateevent) | Optional (OneOf) | An event indicating a task status update. |
| `artifactUpdate` | [`TaskArtifactUpdateEvent`](#taskartifactupdateevent) | Optional (OneOf) | An event indicating a task artifact update. |
...
#### 3.2.4. History Length Semantics[¶](#324-history-length-semantics "Permanent link")
...
#### 3.2.5. Metadata[¶](#325-metadata "Permanent link")
...
#### 3.2.6 Service Parameters[¶](#326-service-parameters "Permanent link")
...
### 3.3. Operation Semantics[¶](#33-operation-semantics "Permanent link")

#### 3.3.1. Idempotency[¶](#331-idempotency "Permanent link")
...
#### 3.3.2. Error Handling[¶](#332-error-handling "Permanent link")
...
#### 3.3.3. Asynchronous Processing[¶](#333-asynchronous-processing "Permanent link")
...
#### 3.3.4. Capability Validation[¶](#334-capability-validation "Permanent link")
...
### 3.4. Multi-Turn Interactions[¶](#34-multi-turn-interactions "Permanent link")
...
#### 3.4.1. Context Identifier Semantics[¶](#341-context-identifier-semantics "Permanent link")
...
#### 3.4.2. Task Identifier Semantics[¶](#342-task-identifier-semantics "Permanent link")
...
#### 3.4.3. Multi-Turn Conversation Patterns[¶](#343-multi-turn-conversation-patterns "Permanent link")
...
### 3.5. Task Update Delivery Mechanisms[¶](#35-task-update-delivery-mechanisms "Permanent link")
...
#### 3.5.1. Overview of Update Mechanisms[¶](#351-overview-of-update-mechanisms "Permanent link")
...
#### 3.5.2. Streaming Event Delivery[¶](#352-streaming-event-delivery "Permanent link")
...
#### 3.5.3. Push Notification Delivery[¶](#353-push-notification-delivery "Permanent link")
...
### 3.6 Versioning[¶](#36-versioning "Permanent link")
...
#### 3.6.1 Client Responsibilities[¶](#361-client-responsibilities "Permanent link")
...
#### 3.6.2 Server Responsibilities[¶](#362-server-responsibilities "Permanent link")
...
#### 3.6.3 Tooling support[¶](#363-tooling-support "Permanent link")
...
### 3.7 Messages and Artifacts[¶](#37-messages-and-artifacts "Permanent link")
...
## 4. Protocol Data Model[¶](#4-protocol-data-model "Permanent link")
...
### 4.1. Core Objects[¶](#41-core-objects "Permanent link")

#### 4.1.1. Task[¶](#411-task "Permanent link")
...
| `status` | [`TaskStatus`](#taskstatus) | Yes | The current status of a `Task`, including `state` and a `message`. |
| `artifacts` | array of [`Artifact`](#artifact) | No | A set of output artifacts for a `Task`. |
| `history` | array of [`Message`](#message) | No | The history of interactions from a `Task`. |
| `metadata` | `object` | No | A key/value object to store custom metadata about a task. |

#### 4.1.2. TaskStatus[¶](#412-taskstatus "Permanent link")

A container for the status of a task

| Field | Type | Required | Description |
| --- | --- | --- | --- |
| `state` | [`TaskState`](#taskstate) | Yes | The current state of this task. |
| `message` | [`Message`](#message) | No | A message associated with the status. |
| `timestamp` | `timestamp` | No | ISO 8601 Timestamp when the status was recorded. Example: "2023-10-27T10:00:00Z" |

#### 4.1.3. TaskState[¶](#413-taskstate "Permanent link")
...
#### 4.1.4. Message[¶](#414-message "Permanent link")
...
| `role` | [`Role`](#role) | Yes | Identifies the sender of the message. |
| `parts` | array of [`Part`](#part) | Yes | Parts is the container of the message content. |
...
#### 4.1.5. Role[¶](#415-role "Permanent link")
...
#### 4.1.6. Part[¶](#416-part "Permanent link")
...
#### 4.1.7. Artifact[¶](#417-artifact "Permanent link")
...
| `parts` | array of [`Part`](#part) | Yes | The content of the artifact. Must contain at least one part. |
...
### 4.2. Streaming Events[¶](#42-streaming-events "Permanent link")

#### 4.2.1. TaskStatusUpdateEvent[¶](#421-taskstatusupdateevent "Permanent link")
...
| `status` | [`TaskStatus`](#taskstatus) | Yes | The new status of the task. |
| `metadata` | `object` | No | Optional. Metadata associated with the task update. |

#### 4.2.2. TaskArtifactUpdateEvent[¶](#422-taskartifactupdateevent "Permanent link")
...
| `artifact` | [`Artifact`](#artifact) | Yes | The artifact that was generated or updated. |
...
### 4.3. Push Notification Objects[¶](#43-push-notification-objects "Permanent link")

#### 4.3.1. PushNotificationConfig[¶](#431-pushnotificationconfig "Permanent link")

**Error:** Message `PushNotificationConfig` not found.

#### 4.3.2. AuthenticationInfo[¶](#432-authenticationinfo "Permanent link")
...
#### 4.3.3. Push Notification Payload[¶](#433-push-notification-payload "Permanent link")
...
### 4.4. Agent Discovery Objects[¶](#44-agent-discovery-objects "Permanent link")

#### 4.4.1. AgentCard[¶](#441-agentcard "Permanent link")
...
| `supportedInterfaces` | array of [`AgentInterface`](#agentinterface) | Yes | Ordered list of supported interfaces. The first entry is preferred. |
| `provider` | [`AgentProvider`](#agentprovider) | No | The service provider of the agent. |
...
| `capabilities` | [`AgentCapabilities`](#agentcapabilities) | Yes | A2A Capability set supported by the agent. |
| `securitySchemes` | map of string to [`SecurityScheme`](#securityscheme) | No | The security scheme details used for authenticating with this agent. |
| `securityRequirements` | array of [`SecurityRequirement`](#securityrequirement) | No | Security requirements for contacting the agent. |
...
| `skills` | array of [`AgentSkill`](#agentskill) | Yes | Skills represent the abilities of an agent. It is largely a descriptive concept but represents a more focused set of behaviors that the agent is likely to succeed at. |
| `signatures` | array of [`AgentCardSignature`](#agentcardsignature) | No | JSON Web Signatures computed for this `AgentCard`. |
| `iconUrl` | `string` | No | Optional. A URL to an icon for the agent. |

#### 4.4.2. AgentProvider[¶](#442-agentprovider "Permanent link")
...
#### 4.4.3. AgentCapabilities[¶](#443-agentcapabilities "Permanent link")
...
| `extensions` | array of [`AgentExtension`](#agentextension) | No | A list of protocol extensions supported by the agent. |
| `extendedAgentCard` | `boolean` | No | Indicates if the agent supports providing an extended agent card when authenticated. |

#### 4.4.4. AgentExtension[¶](#444-agentextension "Permanent link")
...
#### 4.4.5. AgentSkill[¶](#445-agentskill "Permanent link")
...
| `securityRequirements` | array of [`SecurityRequirement`](#securityrequirement) | No | Security schemes necessary for this skill. |

#### 4.4.6. AgentInterface[¶](#446-agentinterface "Permanent link")
...
#### 4.4.7. AgentCardSignature[¶](#447-agentcardsignature "Permanent link")
...
### 4.5. Security Objects[¶](#45-security-objects "Permanent link")

#### 4.5.1. SecurityScheme[¶](#451-securityscheme "Permanent link")
...
| Field | Type | Required | Description |
| --- | --- | --- | --- |
| `apiKeySecurityScheme` | [`APIKeySecurityScheme`](#apikeysecurityscheme) | Optional (OneOf) | API key-based authentication. |
| `httpAuthSecurityScheme` | [`HTTPAuthSecurityScheme`](#httpauthsecurityscheme) | Optional (OneOf) | HTTP authentication (Basic, Bearer, etc.). |
| `oauth2SecurityScheme` | [`OAuth2SecurityScheme`](#oauth2securityscheme) | Optional (OneOf) | OAuth 2.0 authentication. |
| `openIdConnectSecurityScheme` | [`OpenIdConnectSecurityScheme`](#openidconnectsecurityscheme) | Optional (OneOf) | OpenID Connect authentication. |
| `mtlsSecurityScheme` | [`MutualTlsSecurityScheme`](#mutualtlssecurityscheme) | Optional (OneOf) | Mutual TLS authentication. |
...
#### 4.5.2. APIKeySecurityScheme[¶](#452-apikeysecurityscheme "Permanent link")
...
#### 4.5.3. HTTPAuthSecurityScheme[¶](#453-httpauthsecurityscheme "Permanent link")
...
#### 4.5.4. OAuth2SecurityScheme[¶](#454-oauth2securityscheme "Permanent link")
...
| --- | --- | --- | --- |
| `description` | `string` | No | An optional description for the security scheme. |
| `flows` | [`OAuthFlows`](#oauthflows) | Yes | An object containing configuration information for the supported OAuth 2.0 flows. |
...
#### 4.5.5. OpenIdConnectSecurityScheme[¶](#455-openidconnectsecurityscheme "Permanent link")
...
#### 4.5.6. MutualTlsSecurityScheme[¶](#456-mutualtlssecurityscheme "Permanent link")
...
#### 4.5.7. OAuthFlows[¶](#457-oauthflows "Permanent link")

Defines the configuration for the supported OAuth 2.0 flows.

| Field | Type | Required | Description |
| --- | --- | --- | --- |
| `authorizationCode` | [`AuthorizationCodeOAuthFlow`](#authorizationcodeoauthflow) | Optional (OneOf) | Configuration for the OAuth Authorization Code flow. |
| `clientCredentials` | [`ClientCredentialsOAuthFlow`](#clientcredentialsoauthflow) | Optional (OneOf) | Configuration for the OAuth Client Credentials flow. |
| `implicit` | [`ImplicitOAuthFlow`](#implicitoauthflow) | Optional (OneOf) | Deprecated: Use Authorization Code + PKCE instead. |
| `password` | [`PasswordOAuthFlow`](#passwordoauthflow) | Optional (OneOf) | Deprecated: Use Authorization Code + PKCE or Device Code. |
| `deviceCode` | [`DeviceCodeOAuthFlow`](#devicecodeoauthflow) | Optional (OneOf) | Configuration for the OAuth Device Code flow. |
...
#### 4.5.8. AuthorizationCodeOAuthFlow[¶](#458-authorizationcodeoauthflow "Permanent link")
...
#### 4.5.9. ClientCredentialsOAuthFlow[¶](#459-clientcredentialsoauthflow "Permanent link")
...
#### 4.5.10. DeviceCodeOAuthFlow[¶](#4510-devicecodeoauthflow "Permanent link")
...
### 4.6. Extensions[¶](#46-extensions "Permanent link")
...
#### 4.6.1. Extension Declaration[¶](#461-extension-declaration "Permanent link")
...
#### 4.6.2. Extensions Points[¶](#462-extensions-points "Permanent link")
...
#### 4.6.3. Extension Versioning and Compatibility[¶](#463-extension-versioning-and-compatibility "Permanent link")
...
## 5. Protocol Binding Requirements and Interoperability[¶](#5-protocol-binding-requirements-and-interoperability "Permanent link")

### 5.1. Functional Equivalence Requirements[¶](#51-functional-equivalence-requirements "Permanent link")
...
### 5.2. Protocol Selection and Negotiation[¶](#52-protocol-selection-and-negotiation "Permanent link")
...
### 5.3. Method Mapping Reference[¶](#53-method-mapping-reference "Permanent link")
...
### 5.4. Error Code Mappings[¶](#54-error-code-mappings "Permanent link")
...
### 5.5. JSON Field Naming Convention[¶](#55-json-field-naming-convention "Permanent link")

All JSON serializations of the A2A protocol data model **MUST** use **camelCase** naming for field names, not the snake\_case convention used in Protocol Buffer definitions.
...
* Enum values **MUST** be represented according to the [ProtoJSON specification](https://protobuf.dev/programming-guides/json/), which serializes enums as their string names **as defined in the Protocol Buffer definition** (typically SCREAMING\_SNAKE\_CASE).
...
### 5.6. Data Type Conventions[¶](#56-data-type-conventions "Permanent link")
...
#### 5.6.1. Timestamps[¶](#561-timestamps "Permanent link")
...
### 5.7. Field Presence and Optionality[¶](#57-field-presence-and-optionality "Permanent link")
...
### 5.8. Custom Binding Identification[¶](#58-custom-binding-identification "Permanent link")
...
## 6. Common Workflows & Examples[¶](#6-common-workflows-examples "Permanent link")

This section provides illustrative examples of common A2A interactions across different bindings.

### 6.1. Basic Task Execution[¶](#61-basic-task-execution "Permanent link")
...
### 6.2. Streaming Task Execution[¶](#62-streaming-task-execution "Permanent link")
...
### 6.3. Multi-Turn Interaction[¶](#63-multi-turn-interaction "Permanent link")
...
### 6.4. Version Negotiation Error[¶](#64-version-negotiation-error "Permanent link")
...
### 6.5. Task Listing and Management[¶](#65-task-listing-and-management "Permanent link")

**Scenario:** Client wants to see all tasks from a specific context or all tasks with a particular status.

#### Request: All tasks from a specific context[¶](#request-all-tasks-from-a-specific-context "Permanent link")
...
#### Request: All working tasks across all contexts[¶](#request-all-working-tasks-across-all-contexts "Permanent link")
...
#### Pagination Example[¶](#pagination-example "Permanent link")
...
#### Validation Error Example[¶](#validation-error-example "Permanent link")
...
### 6.6. Push Notification Setup and Usage[¶](#66-push-notification-setup-and-usage "Permanent link")
...
### 6.7. File Exchange (Upload and Download)[¶](#67-file-exchange-upload-and-download "Permanent link")
...
### 6.8. Structured Data Exchange[¶](#68-structured-data-exchange "Permanent link")
...
### 6.9. Fetching Authenticated Extended Agent Card[¶](#69-fetching-authenticated-extended-agent-card "Permanent link")
...
### Step 2: Client obtains credentials (out-of-band OAuth 2.0 flow)[¶](#step-2-client-obtains-credentials-out-of-band-oauth-20-flow "Permanent link")

### Step 3: Client fetches authenticated extended Agent Card[¶](#step-3-client-fetches-authenticated-extended-agent-card "Permanent link")
...
## 7. Authentication and Authorization[¶](#7-authentication-and-authorization "Permanent link")
...
For a comprehensive guide on enterprise security aspects, see [Enterprise-Ready Features](../topics/enterprise-ready/).

### 7.1. Protocol Security[¶](#71-protocol-security "Permanent link")
...
### 7.2. Server Identity Verification[¶](#72-server-identity-verification "Permanent link")
...
### 7.3. Client Authentication Process[¶](#73-client-authentication-process "Permanent link")
...
### 7.4. Server Authentication Responsibilities[¶](#74-server-authentication-responsibilities "Permanent link")
...
### 7.5. Server Authorization Responsibilities[¶](#75-server-authorization-responsibilities "Permanent link")
...
### 7.6. In-Task Authorization[¶](#76-in-task-authorization "Permanent link")
...
#### 7.6.1 In-Task Authorization Agent Responsibilities[¶](#761-in-task-authorization-agent-responsibilities "Permanent link")
...
#### 7.6.2 In-Task Authorization Client Responsibilities[¶](#762-in-task-authorization-client-responsibilities "Permanent link")
...
#### 7.6.3 In-Task Authorization Security Considerations[¶](#763-in-task-authorization-security-considerations "Permanent link")
...
## 8. Agent Discovery: The Agent Card[¶](#8-agent-discovery-the-agent-card "Permanent link")

### 8.1. Purpose[¶](#81-purpose "Permanent link")
...
For more on discovery strategies, see the [Agent Discovery guide](../topics/agent-discovery/).

### 8.2. Discovery Mechanisms[¶](#82-discovery-mechanisms "Permanent link")
...
### 8.3. Protocol Declaration Requirements[¶](#83-protocol-declaration-requirements "Permanent link")

The AgentCard **MUST** properly declare supported protocols:

#### 8.3.1. Supported Interfaces Declaration[¶](#831-supported-interfaces-declaration "Permanent link")
...
#### 8.3.2. Client Protocol Selection[¶](#832-client-protocol-selection "Permanent link")
...
### 8.4. Agent Card Signing[¶](#84-agent-card-signing "Permanent link")
...
#### 8.4.1. Canonicalization Requirements[¶](#841-canonicalization-requirements "Permanent link")
...
#### 8.4.2. Signature Format[¶](#842-signature-format "Permanent link")
...
#### 8.4.3. Signature Verification[¶](#843-signature-verification "Permanent link")
...
### 8.5. Sample Agent Card[¶](#85-sample-agent-card "Permanent link")
...
### 8.6. Caching[¶](#86-caching "Permanent link")
...
#### 8.6.1. Server Requirements[¶](#861-server-requirements "Permanent link")
...
#### 8.6.2. Client Requirements[¶](#862-client-requirements "Permanent link")
...
## 9. JSON-RPC Protocol Binding[¶](#9-json-rpc-protocol-binding "Permanent link")
...
### 9.1. Protocol Requirements[¶](#91-protocol-requirements "Permanent link")
...
### 9.2. Service Parameter Transmission[¶](#92-service-parameter-transmission "Permanent link")
...
### 9.3. Base Request Structure[¶](#93-base-request-structure "Permanent link")
...
### 9.4. Core Methods[¶](#94-core-methods "Permanent link")

#### 9.4.1. `SendMessage`[¶](#941-sendmessage "Permanent link")
...
#### 9.4.2. `SendStreamingMessage`[¶](#942-sendstreamingmessage "Permanent link")
...
#### 9.4.3. `GetTask`[¶](#943-gettask "Permanent link")
...
#### 9.4.4. `ListTasks`[¶](#944-listtasks "Permanent link")
...
#### 9.4.5. `CancelTask`[¶](#945-canceltask "Permanent link")
...
#### 9.4.6. `SubscribeToTask`[¶](#946-subscribetotask "Permanent link")
...
#### 9.4.7. Push Notification Configuration Methods[¶](#947-push-notification-configuration-methods "Permanent link")
...
#### 9.4.8. `GetExtendedAgentCard`[¶](#948-getextendedagentcard "Permanent link")
...
### 9.5. Error Handling[¶](#95-error-handling "Permanent link")
...
## 10. gRPC Protocol Binding[¶](#10-grpc-protocol-binding "Permanent link")
...
### 10.1. Protocol Requirements[¶](#101-protocol-requirements "Permanent link")
...
### 10.2. Service Parameter Transmission[¶](#102-service-parameter-transmission "Permanent link")
...
### 10.3. Service Definition[¶](#103-service-definition "Permanent link")

| Method | Request | Response | Description |
| --- | --- | --- | --- |
| `SendMessage` | [`SendMessageRequest`](#sendmessagerequest) | [`SendMessageResponse`](#sendmessageresponse) | Sends a message to an agent. |
| `SendStreamingMessage` | [`SendMessageRequest`](#sendmessagerequest) | stream [`StreamResponse`](#streamresponse) | Sends a streaming message to an agent, allowing for real-time interaction and status updates. Streaming version of `SendMessage` |
| `GetTask` | [`GetTaskRequest`](#gettaskrequest) | [`Task`](#task) | Gets the latest state of a task. |
| `ListTasks` | [`ListTasksRequest`](#listtasksrequest) | [`ListTasksResponse`](#listtasksresponse) | Lists tasks that match the specified filter. |
| `CancelTask` | [`CancelTaskRequest`](#canceltaskrequest) | [`Task`](#task) | Cancels a task in progress. |
| `SubscribeToTask` | [`SubscribeToTaskRequest`](#subscribetotaskrequest) | stream [`StreamResponse`](#streamresponse) | Subscribes to task updates for tasks not in a terminal state. Returns `UnsupportedOperationError` if the task is already in a terminal state (completed, failed, canceled, rejected). |
| `CreateTaskPushNotificationConfig` | [`TaskPushNotificationConfig`](#taskpushnotificationconfig) | [`TaskPushNotificationConfig`](#taskpushnotificationconfig) | Creates a push notification config for a task. |
| `GetTaskPushNotificationConfig` | [`GetTaskPushNotificationConfigRequest`](#gettaskpushnotificationconfigrequest) | [`TaskPushNotificationConfig`](#taskpushnotificationconfig) | Gets a push notification config for a task. |
| `ListTaskPushNotificationConfigs` | [`ListTaskPushNotificationConfigsRequest`](#listtaskpushnotificationconfigsrequest) | [`ListTaskPushNotificationConfigsResponse`](#listtaskpushnotificationconfigsresponse) | Get a list of push notifications configured for a task. |
| `GetExtendedAgentCard` | [`GetExtendedAgentCardRequest`](#getextendedagentcardrequest) | [`AgentCard`](#agentcard) | Gets the extended agent card for the authenticated agent. |
| `DeleteTaskPushNotificationConfig` | [`DeleteTaskPushNotificationConfigRequest`](#deletetaskpushnotificationconfigrequest) | `empty` | Deletes a push notification config for a task. |

### 10.4. Core Methods[¶](#104-core-methods "Permanent link")

#### 10.4.1. SendMessage[¶](#1041-sendmessage "Permanent link")
...
| Field | Type | Required | Description |
| --- | --- | --- | --- |
| `task` | [`Task`](#task) | Optional (OneOf) | The task created or updated by the message. |
| `message` | [`Message`](#message) | Optional (OneOf) | A message from the agent. |

**Note:** A `SendMessageResponse` MUST contain exactly one of the following: `task`, `message`

#### 10.4.2. SendStreamingMessage[¶](#1042-sendstreamingmessage "Permanent link")
...
#### 10.4.3. GetTask[¶](#1043-gettask "Permanent link")
...
#### 10.4.4. ListTasks[¶](#1044-listtasks "Permanent link")
...
#### 10.4.5. CancelTask[¶](#1045-canceltask "Permanent link")
...
#### 10.4.6. SubscribeToTask[¶](#1046-subscribetotask "Permanent link")
...
#### 10.4.7. CreateTaskPushNotificationConfig[¶](#1047-createtaskpushnotificationconfig "Permanent link")
...
#### 10.4.8. GetTaskPushNotificationConfig[¶](#1048-gettaskpushnotificationconfig "Permanent link")
...
#### 10.4.9. ListTaskPushNotificationConfigs[¶](#1049-listtaskpushnotificationconfigs "Permanent link")
...
#### 10.4.10. DeleteTaskPushNotificationConfig[¶](#10410-deletetaskpushnotificationconfig "Permanent link")
...
#### 10.4.11. GetExtendedAgentCard[¶](#10411-getextendedagentcard "Permanent link")
...
### 10.5. gRPC-Specific Data Types[¶](#105-grpc-specific-data-types "Permanent link")

#### 10.5.1. TaskPushNotificationConfig[¶](#1051-taskpushnotificationconfig "Permanent link")
...
### 10.6. Error Handling[¶](#106-error-handling "Permanent link")
...
* `reason`: The A2A error type in UPPER\_SNAKE\_CASE without the "Error" suffix (e.g., `TASK_NOT_FOUND`)
...
### 10.7. Streaming[¶](#107-streaming "Permanent link")
...
## 11. HTTP+JSON/REST Protocol Binding[¶](#11-httpjsonrest-protocol-binding "Permanent link")

The HTTP+JSON protocol binding provides a RESTful interface using standard HTTP methods and JSON payloads.

### 11.1. Protocol Requirements[¶](#111-protocol-requirements "Permanent link")
...
### 11.2. Service Parameter Transmission[¶](#112-service-parameter-transmission "Permanent link")
...
### 11.3. URL Patterns and HTTP Methods[¶](#113-url-patterns-and-http-methods "Permanent link")

#### 11.3.1. Message Operations[¶](#1131-message-operations "Permanent link")

* `POST /message:send` - Send message
* `POST /message:stream` - Send message with streaming (SSE response)

#### 11.3.2. Task Operations[¶](#1132-task-operations "Permanent link")
...
#### 11.3.3. Push Notification Configuration[¶](#1133-push-notification-configuration "Permanent link")
...
#### 11.3.4. Agent Card[¶](#1134-agent-card "Permanent link")

* `GET /extendedAgentCard` - Get authenticated extended Agent Card

### 11.4. Request/Response Format[¶](#114-requestresponse-format "Permanent link")
...
### 11.5. Query Parameter Naming for Request Parameters[¶](#115-query-parameter-naming-for-request-parameters "Permanent link")
...
### 11.6. Error Handling[¶](#116-error-handling "Permanent link")
...
* `reason`: The A2A error type in UPPER\_SNAKE\_CASE without the "Error" suffix (e.g., `TASK_NOT_FOUND`, `TASK_NOT_CANCELABLE`)
* `domain`: Set to `"a2a-protocol.org"`
...
### 11.7. Streaming[¶](#117-streaming "Permanent link")
...
## 12. Custom Binding Guidelines[¶](#12-custom-binding-guidelines "Permanent link")
...
### 12.1. Binding Requirements[¶](#121-binding-requirements "Permanent link")
...
### 12.2. Data Type Mappings[¶](#122-data-type-mappings "Permanent link")
...
### 12.3. Service Parameter Transmission[¶](#123-service-parameter-transmission "Permanent link")
...
### 12.4. Error Mapping[¶](#124-error-mapping "Permanent link")
...
### 12.5. Streaming Support[¶](#125-streaming-support "Permanent link")
...
### 12.6. Authentication and Authorization[¶](#126-authentication-and-authorization "Permanent link")
...
### 12.7. Agent Card Declaration[¶](#127-agent-card-declaration "Permanent link")
...
### 12.8. Interoperability Testing[¶](#128-interoperability-testing "Permanent link")
...
## 13. Security Considerations[¶](#13-security-considerations "Permanent link")

This section consolidates security guidance and best practices for implementing and operating A2A agents. For additional enterprise security considerations, see [Enterprise-Ready Features](../topics/enterprise-ready/).

### 13.1. Data Access and Authorization Scoping[¶](#131-data-access-and-authorization-scoping "Permanent link")
...
### 13.2. Push Notification Security[¶](#132-push-notification-security "Permanent link")
...
### 13.3. Extended Agent Card Access Control[¶](#133-extended-agent-card-access-control "Permanent link")
...
### 13.4. General Security Best Practices[¶](#134-general-security-best-practices "Permanent link")
...
## 14. IANA Considerations[¶](#14-iana-considerations "Permanent link")
...
### 14.1. Media Type Registration[¶](#141-media-type-registration "Permanent link")

#### 14.1.1. application/a2a+json[¶](#1411-applicationa2ajson "Permanent link")
...
### 14.2. HTTP Header Field Registrations[¶](#142-http-header-field-registrations "Permanent link")
...
#### 14.2.1. A2A-Version Header[¶](#1421-a2a-version-header "Permanent link")
...
#### 14.2.2. A2A-Extensions Header[¶](#1422-a2a-extensions-header "Permanent link")
...
### 14.3. Well-Known URI Registration[¶](#143-well-known-uri-registration "Permanent link")
...
## Appendix A. Migration & Legacy Compatibility[¶](#appendix-a-migration-legacy-compatibility "Permanent link")
...
### A.1 Legacy Documentation Anchors[¶](#a1-legacy-documentation-anchors "Permanent link")
...
### A.2 Migration Guidance[¶](#a2-migration-guidance "Permanent link")
...
#### A.2.1 Breaking Change: Kind Discriminator Removed[¶](#a21-breaking-change-kind-discriminator-removed "Permanent link")
...
#### A.2.2 Breaking Change: Extended Agent Card Field Relocated[¶](#a22-breaking-change-extended-agent-card-field-relocated "Permanent link")
...
### A.3 Future Automation[¶](#a3-future-automation "Permanent link")
...
## Appendix B. Relationship to MCP (Model Context Protocol)[¶](#appendix-b-relationship-to-mcp-model-context-protocol "Permanent link")
...
For a more detailed comparison, see the [A2A and MCP guide](../topics/a2a-and-mcp/).
