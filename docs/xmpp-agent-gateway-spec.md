...
<iq type="set"
    ...
    id="register-1">
  <register xmlns="urn:solstice:agent-api:1">
...
<iq type="result"
    ...
    id="register-1">
  <registered xmlns="urn:solstice:agent-api:1"
...
urn:solstice:agent-task:progress:1
urn:solstice:agent-task:cancel:1
urn:solstice:agent-task:input-required:1
urn:solstice:mcp-endpoint:1
urn:solstice:mcp-tool-info:1
```
...
<iq type="result"
  ...
  <query xmlns="http://jabber.org/protocol/disco#info">
    ...
    <feature var="urn:solstice:agent-directory:1"/>
    <feature var="urn:solstice:agent-api:1"/>
    <feature var="urn:solstice:agent-task:1"/>
    <feature var="urn:solstice:mcp-endpoint:1"/>
  </query>
</iq>
```
...
<iq type="get"
  ...
  <query xmlns="http://jabber.org/protocol/disco#items"
         node="urn:solstice:agent-directory:1"/>
</iq>
```
...
<iq type="result"
  ...
  <query xmlns="http://jabber.org/protocol/disco#items"
    ...
    <item jid="security-reviewer@agents.acme.example"
          node="urn:solstice:mcp-endpoint:1"
          name="Security Reviewer"/>
...
<iq type="result"
  ...
  <query xmlns="http://jabber.org/protocol/disco#info"
    ...
    <feature var="urn:solstice:agent-api:1"/>
    <feature var="urn:solstice:agent-task:1"/>
    <feature var="urn:solstice:agent-task:progress:1"/>
    <feature var="urn:solstice:agent-task:cancel:1"/>
    <feature var="urn:solstice:agent-task:input-required:1"/>

    <x xmlns="jabber:x:data" type="result">
      <field var="FORM_TYPE" type="hidden">
        <value>urn:solstice:mcp-endpoint-info:1</value>
      </field>
...
<iq type="result"
  ...
  <query xmlns="http://jabber.org/protocol/disco#items"
    ...
    <item jid="security-reviewer@agents.acme.example"
          node="urn:solstice:agent-operation:1#review_branch"
          name="Review Git branch"/>

    <item jid="security-reviewer@agents.acme.example"
          node="urn:solstice:agent-operation:1#review_pull_request"
          name="Review pull request"/>

    <item jid="security-reviewer@agents.acme.example"
          node="urn:solstice:agent-operation:1#threat_model"
...
<iq type="result"
  ...
  <query xmlns="http://jabber.org/protocol/disco#info"
    ...
    <feature var="urn:solstice:agent-operation:1"/>
    <feature var="urn:solstice:agent-task:progress:1"/>
    <feature var="urn:solstice:agent-task:cancel:1"/>
    <feature var="urn:solstice:agent-task:input-required:1"/>
    ...
    <x xmlns="jabber:x:data" type="result">
      <field var="FORM_TYPE" type="hidden">
        <value>urn:solstice:mcp-tool-info:1</value>
      </field>
...
```json
{
  ...
  "xmpp": {
    "jid": "security-reviewer@agents.acme.example",
    "endpointNode": "urn:solstice:mcp-endpoint:1",
    "toolsNode": "urn:solstice:agent-api:1",
    "features": [
      "urn:solstice:agent-task:1",
      "urn:solstice:agent-task:progress:1",
      "urn:solstice:agent-task:cancel:1"
...
<iq type="get"
    ...
    to="security-reviewer@agents.acme.example"
    id="schema-1">
  <schema xmlns="urn:solstice:agent-api:1"
...
```json
{
  ...
  "serverInfo": {
    "name": "solstice-xmpp-agent-gateway",
...
```json
{
  ...
  "_meta": {
    "solstice/endpointId": "xmpp+mcp://security-reviewer@agents.acme.example",
    "solstice/operation": "review_branch",
    "solstice/apiVersion": "1.4.0",
    "solstice/inputSchemaDigest": "sha-256:84394c...",
    "solstice/outputSchemaDigest": "sha-256:1134ab..."
  }
}
```
...
```json
{
  ...
  "_meta": {
    "solstice/taskId": "task-01JZ8M...",
    "solstice/target": "security-reviewer@agents.acme.example"
  }
}
```
...
<message
  ...
  <invoke xmlns="urn:solstice:agent-task:1"
...
<message
  ...
  <accepted xmlns="urn:solstice:agent-task:1"
            task-id="task-01JZ8M0"
            correlation-id="mcp-call-938"
...
<message
  ...
  <progress xmlns="urn:solstice:agent-task:1"
            task-id="task-01JZ8M0"
            sequence="3"
            percent="45"
            stage="analysis">
...
<message
  ...
  <result xmlns="urn:solstice:agent-task:1"
          task-id="task-01JZ8M0"
          correlation-id="mcp-call-938"
          operation="review_branch"
          api-version="1.4.0"
...
<message
  ...
  <cancel xmlns="urn:solstice:agent-task:1"
          task-id="task-01JZ8M0"
...
<message
  ...
  <input-required xmlns="urn:solstice:agent-task:1"
                  task-id="task-01JZ8M0"
                  request-id="input-1">
...
<message
  ...
  <input xmlns="urn:solstice:agent-task:1"
         task-id="task-01JZ8M0"
         request-id="input-1">
...
<message
  ...
  <x xmlns="jabber:x:data" type="form">
    ...
    <field var="FORM_TYPE" type="hidden">
      <value>urn:solstice:agent-task-input:1</value>
    </field>
